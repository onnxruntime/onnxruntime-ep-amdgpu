...
class Node {
  ...
  */
  ...
  @returns Ort::Status with success or error information.
  @remarks Returns immediately on error.
  */
  static Ort::Status ForEachWithIndex(const ConstPointerContainer<std::vector<NodeArg*>>& node_args,
                                         std::function<Ort::Status(const NodeArg& arg, size_t index)> func) {
  ...
  @remarks Returns immediately on error.
  */
  static Ort::Status ForEachMutableWithIndex(std::vector<NodeArg*>& node_args,
                                                std::function<Ort::Status(NodeArg& arg, size_t index)> func) {
    for (size_t index = 0; index < node_args.size(); ++index) {
      auto arg = node_args[index];
      if (!arg->Exists())
        continue;
...
#undef ADD_ATTR_INTERFACES
  ...
  */
  ...
  Ort::Status SaveToOrtFormat(flatbuffers::FlatBufferBuilder& builder,
  ...
  static Ort::Status LoadFromOrtFormat(const onnxruntime::fbs::Node& fbs_node, Graph& graph,
                                  const OrtFormatLoadOptions& load_options,
                                  const Ort::Logger& logger, std::unique_ptr<Node>& node);

  Ort::Status LoadFromOrtFormat(const onnxruntime::fbs::Node& fbs_node,
                           const OrtFormatLoadOptions& load_options,
                           const Ort::Logger& logger);
  Ort::Status LoadEdgesFromOrtFormat(const onnxruntime::fbs::NodeEdge& fbs_node_edgs, const Graph& graph);
 ...
 private:
  ...
  Ort::Status UpdateInputArgCount();
...
class Graph {  // NOLINT(clang-analyzer-optin.performance.Padding): preserve existing data member order for readability
  ...
  */
  Ort::Status ReplaceInitializedTensor(const ONNX_NAMESPACE::TensorProto& new_initializer, const OrtValue& ort_value);
   ...
   */
  Ort::Status InjectExternalInitializedTensors(const InlinedHashMap<std::string, OrtValue>& external_initializers);
   ...
   */
  Ort::Status InjectExternalInitializersFromFilesInMemory(
  ...
  Ort::Status AddInitializedOrtValue(const ONNX_NAMESPACE::TensorProto& tensor_proto,
  ...
  */
  ...
  Ort::Status LoadExternalInitializerAsOrtValue(const std::string& name, OrtValue& value) const;
  ...
  */
  ...
  Ort::Status ToGraphProtoWithCustomInitializerHandling(OrtGetInitializerLocationFunc handle_initializer_func,
                                                           void* state,
  ...
  */
  ...
  /**
    ...
    @param logger
  */
  Ort::Status InlineIfSubgraph(bool condition_value, Node& if_node, const Ort::Logger& logger);
  ...
  @returns Ort::Status indicating success or providing an error message.
  */
  Ort::Status InlineFunction(Node& node);
  ...
  */
  ...
  Ort::Status InlineFunctionProto(const ONNX_NAMESPACE::FunctionProto& func_to_inline);
  ...
  */
  ...
  const Ort::Logger& GetLogger() const {
    return logger_;
  }
  ...
  */
  Ort::Status UpdateShapeInference(Node& node);
  ...
  @returns Ort::Status with success or error information.
  */
  Ort::Status Resolve(const ResolveOptions& options);
  ...
  /// </summary>
  /// <returns></returns>
  Ort::Status ConvertInitializersIntoOrtValues();
   ...
   * @return Ort::Status Returns a Ort::Status object indicating success or any errors that occurred during conversion
   */
  Ort::Status RegenerateInitializersAndReplaceInMemory(gsl::span<const InitializedTensorSet::const_iterator> iterators,
  ...
  */
  ...
  static Ort::Status LoadFromOrtFormat(const onnxruntime::fbs::Graph& fbs_graph, const Model& owning_model,
  ...
  static Ort::Status LoadFromOrtFormat(const onnxruntime::fbs::Graph& fbs_graph,
                                  Graph& parent_graph, const Node& parent_node,
                                  const OrtFormatLoadOptions& load_options,
                                  const Ort::Logger& logger, std::unique_ptr<Graph>& graph);

  static Ort::Status LoadFromModelEditorApiModel(const OrtGraph& api_graph,
  ...
  Ort::Status UpdateUsingModelEditorApiModel(const OrtModel& api_model);
  ...
  Ort::Status RemovedUnusedInitializersOrtFormat();
#endif  // !defined(ORT_MINIMAL_BUILD) || defined(ORT_EXTENDED_MINIMAL_BUILD)
  ...
  Ort::Status LoadFromOrtFormat(const onnxruntime::fbs::Graph& fbs_graph,
                           const OrtFormatLoadOptions& load_options);
  ...
  */
  Ort::Status AddConstantProtoAsInitializer(const ONNX_NAMESPACE::NodeProto& constant_node_proto,
  ...
  Ort::Status ProcessSubgraphsInMemoryData(ONNX_NAMESPACE::GraphProto& output_graph_proto) const;
  ...
  Ort::Status AddExternalInitializersToGraphProtoImpl(
  ...
  Ort::Status ToGraphProtoWithCustomInitializerHandlingImpl(OrtGetInitializerLocationFunc handle_initializer_func,
                                                       void* state,
  ...
  Ort::Status InitInputsInitializersOutputs();
  ...
  Ort::Status BuildConnections(std::unordered_set<std::string>& outer_scope_node_args_consumed,
                                  bool& removed_node_with_subgraph);

  Ort::Status VerifyNoDuplicateName();
  ...
  // order if <Ort::Status> returned is "OK", otherwise it's undefined.
  Ort::Status PerformTopologicalSortAndCheckIsAcyclic();

  Ort::Status PerformTypeAndShapeInferencing(const ResolveOptions& options);

  Ort::Status InferAndVerifyTypeMatch(Node& node, const ONNX_NAMESPACE::OpSchema& op, const ResolveOptions& options);

  // perform type and shape inferencing on the subgraph and Resolve to validate
  static Ort::Status InferAndVerifySubgraphTypes(const Node& node, Graph& subgraph,
  ...
  Ort::Status SaveShapeValuesFromDataPropagation(const Node& node, NodeArg& output_def,
  ...
  Ort::Status CleanUpShapeValuesFromDataPropagation();

  // Apply type-inference and type-checking to all inputs and initializers:
  Ort::Status TypeCheckInputsAndInitializers();

  // Compute set of input and initializer names and checking for duplicate names
  Ort::Status VerifyInputAndInitializerNames();
  ...
  Ort::Status VerifyNodeAndOpMatch(const ResolveOptions& options);

  // Set graph inputs/outputs when resolving a graph..
  Ort::Status SetGraphInputsOutputs();
  ...
  Ort::Status SetOuterScopeNodeArgs(const std::unordered_set<std::string>& outer_scope_node_args);
  ...
  /// <returns></returns>
  Ort::Status ReplaceInitializedTensorImpl(ONNX_NAMESPACE::TensorProto new_initializer,
  ...
  Ort::Status ForThisAndAllSubgraphs(const std::vector<Graph*>& subgraphs, std::function<Ort::Status(Graph&)> func);
  ...
  Ort::Status PopulateNodeArgToProducerConsumerLookupsFromNodes();
  ...
  Node* NodeAtIndexImpl(NodeIndex node_index) const {
    ...
    //ENFORCE(node_index < nodes_.size(), "Validating no unexpected access using an invalid node_index. Got:",
    //            node_index, " Max:", nodes_.size());
    return nodes_[node_index].get();
  }

  Ort::Status LoadFromModelEditorApiModel(const OrtGraph& api_graph, bool updating_existing_graph = false);
...
template <> struct fmt::formatter<onnxruntime::NodeArg> : formatter<std::string> {
    format_context::iterator format(const onnxruntime::NodeArg& node_arg, format_context& ctx) const {
        std::string name{"\"" + node_arg.Name() + "\""};
        if (node_arg.Type()) {
            name += ": " + *node_arg.Type();
        }
...
template <> struct fmt::formatter<onnxruntime::Node> : formatter<std::string> {
    format_context::iterator format(const onnxruntime::Node& node, format_context& ctx) const {
        std::string out{"(\"" + node.Name() + "\", " + node.OpType() + ", \"" +
            node.Domain() + "\"," + std::to_string(node.SinceVersion()) + ")"};
...
template <> struct fmt::formatter<onnxruntime::Graph> : formatter<std::string> {
    format_context::iterator format(const onnxruntime::Graph& graph, format_context& ctx) const {
