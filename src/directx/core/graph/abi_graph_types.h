...
// Forward declaration for use in OrtValueInfo
struct OrtNodePlugin;
...
struct OrtValueInfo {
  ...
  struct ProducerInfo {
    ...
    ProducerInfo(const OrtNodePlugin* producer_node, size_t output_index) : producer_node(producer_node), output_index(output_index) {}
    const OrtNodePlugin* producer_node = nullptr;
  ...
  virtual Ort::Status GetProducerInfo(ProducerInfo& producer_info) const = 0;

  struct ConsumerInfo {
    ConsumerInfo() = default;
    ConsumerInfo(const OrtNodePlugin* consumer_node, int64_t input_index) : consumer_node(consumer_node), input_index(input_index) {}
    const OrtNodePlugin* consumer_node = nullptr;
  ...
  /// <returns>A status indicating success or an error.</returns>
  virtual Ort::Status GetConsumerInfos(std::vector<ConsumerInfo>& consumer_infos) const = 0;
  ...
  /// <returns>A status indicating success or an error.</returns>
  virtual Ort::Status GetNumConsumerInfos(size_t& num_consumers) const = 0;
  ...
  /// <returns>A status indicating success or an error.</returns>
  virtual Ort::Status GetInitializerValue(const OrtValue*& value) const = 0;
  ...
  virtual Ort::Status GetExternalInitializerInfo(
  ...
  /// <returns>A status indicating success or an error.</returns>
  virtual Ort::Status IsRequiredGraphInput(bool& is_required_graph_input) const = 0;
  ...
  ///                                       input.</param>
  /// <returns>A status indicating success or an error.</returns>
  virtual Ort::Status IsOptionalGraphInput(bool& is_optional_graph_input) const = 0;
  ...
  /// <returns>A status indicating success or an error.</returns>
  virtual Ort::Status IsGraphOutput(bool& is_graph_output) const = 0;
  ...
  ///                                    initializer.</param>
  /// <returns>A status indicating success or an error.</returns>
  virtual Ort::Status IsConstantInitializer(bool& is_const_initializer) const = 0;
  ...
  /// <returns>A status indicating success or an error.</returns>
  virtual Ort::Status IsFromOuterScope(bool& is_outer_scope) const = 0;
...
/// </summary>
struct OrtNodePlugin {
  explicit OrtNodePlugin(OrtGraphIrApi graph_ir_api) : graph_ir_api(graph_ir_api) {}
  virtual ~OrtNodePlugin() = default;
  ...
  /// <returns>A status indicating success or an error.</returns>
  virtual Ort::Status GetSinceVersion(int& since_version) const = 0;
  ...
  /// <returns>A status indicating success or an error.</returns>
  virtual Ort::Status GetInputs(gsl::span<const OrtValueInfo*> inputs) const = 0;
  ...
  /// <returns>A status indicating success or an error.</returns>
  virtual Ort::Status GetOutputs(gsl::span<const OrtValueInfo*> outputs) const = 0;
  ...
  /// <returns>A status indicating success or an error.</returns>
  virtual Ort::Status GetNumImplicitInputs(size_t& num_implicit_inputs) const = 0;
  ...
  /// <returns>A status indicating success or an error.</returns>
  virtual Ort::Status GetImplicitInputs(gsl::span<const OrtValueInfo*> implicit_inputs) const = 0;
  ...
  /// <returns>A status indicating success or an error.</returns>
  virtual Ort::Status GetAttributes(gsl::span<const OrtOpAttr*> attrs) const = 0;
  ...
  /// <returns>A status indicating success or an error.</returns>
  virtual Ort::Status GetNumSubgraphs(size_t& num_subgraphs) const = 0;
  ...
  /// <returns>A status indicating success or an error.</returns>
  virtual Ort::Status GetSubgraphs(gsl::span<const OrtGraph*> subgraphs,
  ...
  /// <returns>A status indicating success or an error.</returns>
  virtual Ort::Status GetGraph(const OrtGraph*& parent_graph) const = 0;
...
struct OrtGraph {
  ...
  /// <returns>A status indicating success or an error.</returns>
  virtual Ort::Status GetNumOperatorSets(size_t& num_operator_sets) const = 0;
  ...
  /// <returns>A status indicating success or an error.</returns>
  virtual Ort::Status GetOperatorSets(gsl::span<const char*> domains,
  ...
  /// <returns>A status indicating success or an error.</returns>
  virtual Ort::Status GetInitializers(gsl::span<const OrtValueInfo*> initializers) const = 0;
  ...
  /// <returns>A status indicating success or an error.</returns>
  virtual Ort::Status GetNodes(gsl::span<const OrtNodePlugin*> nodes) const = 0;
  ...
  /// <returns>A status indicating success or an error.</returns>
  virtual Ort::Status GetParentNode(const OrtNodePlugin*& parent_node) const = 0;
