...
static Ort::Status SaveRuntimeOptimizationRecordToOrtFormat(
...
Ort::Status RuntimeOptimizationRecordContainer::SaveToOrtFormat(
    flatbuffers::FlatBufferBuilder& builder,
...
static Ort::Status LoadRuntimeOptimizationRecordFromOrtFormat(
...
Ort::Status RuntimeOptimizationRecordContainer::LoadFromOrtFormat(
