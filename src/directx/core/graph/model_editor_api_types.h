...
struct ModelEditorValueInfo : public OrtValueInfo {
  ...
  Ort::Status GetProducerInfo(ProducerInfo& /*producer_info*/) const override {
...
/// </summary>
struct ModelEditorNode : public OrtNodePlugin {
  ModelEditorNode() : OrtNodePlugin(OrtGraphIrApi::kModelEditorApi) {}

  // Defines ToExternal() and ToInternal() functions to convert between OrtNodePlugin and ModelEditorNode.
  DEFINE_ORT_GRAPH_IR_TO_EXTERNAL_INTERNAL_FUNCS(OrtNodePlugin, ModelEditorNode, OrtGraphIrApi::kModelEditorApi)
  ...
  Ort::Status GetImplicitInputs(gsl::span<const OrtValueInfo*> /*implicit_inputs*/) const override {
    return ORT_MAKE_STATUS(ORT_NOT_IMPLEMENTED,
                           "OrtModelEditorApi does not support getting the implicit inputs for OrtNode");
  }
...
struct ModelEditorGraph : public OrtGraph {
  ...
  Ort::Status GetInputs(gsl::span<const OrtValueInfo*> /*result*/) const override {
    return ORT_MAKE_STATUS(ORT_NOT_IMPLEMENTED,
  ...
  Ort::Status GetOutputs(gsl::span<const OrtValueInfo*> /*result*/) const override {
    return ORT_MAKE_STATUS(ORT_NOT_IMPLEMENTED,
  ...
  Ort::Status GetInitializers(gsl::span<const OrtValueInfo*> /*result*/) const override {
    return ORT_MAKE_STATUS(ORT_NOT_IMPLEMENTED,
  ...
  Ort::Status GetNodes(gsl::span<const OrtNodePlugin*> /*result*/) const override {
    return ORT_MAKE_STATUS(ORT_NOT_IMPLEMENTED,
