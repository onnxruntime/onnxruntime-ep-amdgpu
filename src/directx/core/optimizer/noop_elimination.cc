 ...
 */
Ort::Status NoopElimination::Apply(Graph& graph, Node& node, RewriteRuleEffect& rule_effect, const Ort::Logger&) const {
...
bool NoopElimination::SatisfyCondition(const Graph& graph, const Node& node, const Ort::Logger& logger) const {
