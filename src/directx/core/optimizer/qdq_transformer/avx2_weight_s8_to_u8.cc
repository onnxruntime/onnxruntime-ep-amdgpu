...
static bool TryConvertDynamicQuantizeLSTM(Node& op_node, Graph& graph, const Ort::Logger& logger) {
...
Ort::Status Avx2WeightS8ToU8Transformer::ApplyImpl(Graph& graph, bool& modified, int graph_level,
