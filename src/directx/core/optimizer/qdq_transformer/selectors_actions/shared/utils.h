...
class SelectorManager {
 public:
  ...
  std::vector<NodeGroup> GetQDQSelections(const GraphViewer& graph_viewer, const Ort::Logger& logger) const;
...
GetAllNodeUnits(const GraphViewer& graph_viewer, const Ort::Logger& logger);
