...
Ort::Status RemoveNodes::Run(Graph& graph, const NodesToOptimize& selected_nodes) const {
...
Ort::Status MergeIntoTarget::Run(Graph& graph, const NodesToOptimize& selected_nodes) const {
...
static Ort::Status CreateReplacementNode(Graph& graph,
...
Ort::Status ReplaceWithNew::Run(Graph& graph, const NodesToOptimize& selected_nodes) const {
  const RuntimeState runtime_state{graph, selected_nodes};
  Node* replacement{};
...
Ort::Status ReplaceWithNew::RunForSave(Graph& graph, const NodesToOptimize& selected_nodes,
