...
struct Action {
  ...
  virtual Ort::Status Run(Graph& graph, const NodesToOptimize& selected_nodes) const = 0;
  ...
  // saving interface
  virtual Ort::Status RunForSave(Graph& /*graph*/, const NodesToOptimize& /*selected_nodes*/,
...
struct MultiAction : public Action {
  ...
  Ort::Status Run(Graph& graph, const NodesToOptimize& selected_nodes) const override {
...
#if !defined(ORT_MINIMAL_BUILD)
  Ort::Status RunForSave(Graph& graph, const NodesToOptimize& selected_nodes,
                    const SatRuntimeOptimizationSaveContext& save_context,
...
struct ReplaceWithNew : public Action {
 ...
 private:
  ...
  virtual Ort::Status ProcessNewNode(Graph&, const NodesToOptimize&, Node&) const { return STATUS_OK; }
