...
Ort::Status GemmSumFusion::Apply(Graph& graph, Node& gemm_node, RewriteRuleEffect& modified, const Ort::Logger&) const {
...
bool GemmSumFusion::SatisfyCondition(const Graph& graph, const Node& node, const Ort::Logger&) const {
