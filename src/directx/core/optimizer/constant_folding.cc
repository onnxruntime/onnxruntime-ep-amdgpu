...
static Ort::Status ConstantFoldIfNode(Graph& graph, Node& if_node, const Ort::Logger& logger, bool& folded) {
  folded = false;
...
Ort::Status ConstantFolding::ApplyImpl(Graph& graph, bool& modified, int graph_level, const Ort::Logger& logger) const {
