...
Ort::Status UnsqueezeElimination::Apply(Graph& graph, Node& node, RewriteRuleEffect& rule_effect, const Ort::Logger& logger) const {
...
bool UnsqueezeElimination::SatisfyCondition(const Graph& graph, const Node& node, const Ort::Logger&) const {
