...
class UpStreamGatherGraphTransformer
 ...
 private:
  ...
  optimizer::compute_optimizer::SliceInfo PropagateSlicingForInput(Graph& graph, Node& slice_node, Node& current_node,
                                                                   ...
                                                                   int new_axis, const Ort::Logger& logger) const;
   ...
   * @return
   */
  Ort::Status RemoveOriginSlicingOp(Graph& graph, Node& slice_node, Node& current_node,
                               const Ort::Logger& logger, optimizer::compute_optimizer::SliceInfo& info) const;
};
