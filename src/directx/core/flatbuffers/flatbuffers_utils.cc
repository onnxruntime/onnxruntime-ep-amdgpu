...
static Ort::Status SaveTypeInfoOrtFormat(flatbuffers::FlatBufferBuilder& builder,
...
static Ort::Status SaveTensorShapeOrtFormat(flatbuffers::FlatBufferBuilder& builder,
...
static Ort::Status SaveSequenceTypeOrtFormat(flatbuffers::FlatBufferBuilder& builder,
...
static Ort::Status SaveMapTypeOrtFormat(flatbuffers::FlatBufferBuilder& builder,
...
static Ort::Status SaveTensorTypeAndShapeOrtFormat(flatbuffers::FlatBufferBuilder& builder,
...
static Ort::Status SaveTypeInfoOrtFormat(flatbuffers::FlatBufferBuilder& builder,
  ...
  switch (value_case) {
    ...
    default: {
      return ORT_MAKE_STATUS(ORT_INVALID_ARGUMENT, "We do not support type [", value_case, "] for now");
    } break;
  }
...
Ort::Status SaveValueInfoOrtFormat(flatbuffers::FlatBufferBuilder& builder,
...
static Ort::Status LoadTypeInfoOrtFormat(const fbs::TypeInfo& fbs_type_info,
                                    TypeProto& type_proto);

static Ort::Status LoadTensorDimensionOrtFormat(const fbs::Dimension& fbs_dim,
...
static Ort::Status LoadTensorShapeOrtFormat(const fbs::Shape& fbs_shape, TensorShapeProto& shape_proto) {
...
static Ort::Status LoadTensorTypeAndShapeOrtFormat(const fbs::TensorTypeAndShape& fbs_tensor_type,
...
static Ort::Status LoadSequenceTypeOrtFormat(const fbs::SequenceType& fbs_sequence_type,
...
static Ort::Status LoadMapTypeOrtFormat(const fbs::MapType& fbs_map_type,
...
static Ort::Status LoadTypeInfoOrtFormat(const fbs::TypeInfo& fbs_type_info,
  ...
  if (value_type == fbs::TypeInfoValue::tensor_type) {
    ...
    return ORT_MAKE_STATUS(ORT_INVALID_ARGUMENT, "Type:",
...
Ort::Status LoadValueInfoOrtFormat(const fbs::ValueInfo& fbs_value_info,
...
Ort::Status LoadOpsetImportOrtFormat(const flatbuffers::Vector<flatbuffers::Offset<fbs::OperatorSetId>>* fbs_op_set_ids,
