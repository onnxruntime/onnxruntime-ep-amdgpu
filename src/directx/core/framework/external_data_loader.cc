...
Ort::Status IExternalDataLoader::LoadTensor([[maybe_unused]] const Env& env,
...
Ort::Status LoadWebAssemblyExternalData(const Env& env,
  ...
  return ORT_MAKE_STATUS(FAIL, "Failed to load external data file \"", data_file_path,
                         "\", error: ", err_msg);
}
