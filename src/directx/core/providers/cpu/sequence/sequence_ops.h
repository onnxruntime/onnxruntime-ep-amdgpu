...
class SplitToSequence final : public OpKernel {
 ...
 private:
  Ort::Status ComputeImpl(OpKernelContext& context, const Tensor& input, const Tensor* p_split_input) const;
  Ort::Status PrepareForCompute(const TensorShape& input_shape, int64_t split_scalar, bool is_split_input_scalar,
