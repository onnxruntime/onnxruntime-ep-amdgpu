...
Ort::Status RegisterOnnxOperatorKernels(KernelRegistry& kernel_registry) {
...
#ifdef MLAS_F16VEC_INTRINSICS_SUPPORTED
Ort::Status RegisterFp16Kernels(KernelRegistry& kernel_registry) {
  static const BuildKernelCreateInfoFn function_table[] = {
      BuildKernelCreateInfo<void>,  // default entry to avoid the list become empty after ops-reducing
...
Ort::Status RegisterOnnxMLOperatorKernels(KernelRegistry& kernel_registry) {
  static const BuildKernelCreateInfoFn function_table[] = {
      BuildKernelCreateInfo<void>,  // default entry to avoid the list become empty after ops-reducing
...
Ort::Status RegisterCPUKernels(KernelRegistry& kernel_registry) {
