...
class OutputIterator {
 public:
  static Ort::Status Create(OpKernelContextInternal& context,
                       int output_index,
 ...
 private:
  ...
  Ort::Status AllocateFinalBuffer();
...
Ort::Status AllocateOutput(OpKernelContextInternal& context, const GraphViewer& subgraph,
...
Ort::Status CreateFeedsFetchesManager(const Node& node, const Info& info,
                                 const SessionState& session_state,
                                 const SessionState& subgraph_session_state,
                                 bool is_v8,
                                 std::unique_ptr<FeedsFetchesManager>& feeds_fetches_manager);

Ort::Status IterateSequence(OpKernelContextInternal& context, const SessionState& session_state,
