...
public:
    ...
    :   DmlOperator(kernelCreationContext)
    {
        ...
        if (kernelCreationContext.IsInputValid(1))
        {
            ...
            OperatorHelper::ReadScalarTensorData(axisTensor, /*out*/ tensorBytes, sizeof(tensorBytes));
            onnxAxis = gsl::narrow_cast<int32_t>(OperatorHelper::CastToInt64(axisTensor.GetTensorDataType(), /*out*/ tensorBytes));
        }
