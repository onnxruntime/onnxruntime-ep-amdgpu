 ...
 */
bool MatmulBNFusion::SatisfyCondition(const Graph& graph, const Node& node, const Ort::Logger&) const {
 ...
 *
 */
Ort::Status MatmulBNFusion::Apply(Graph& graph, Node& matmul_node, RewriteRuleEffect& rule_effect, const Ort::Logger&) const {
