...
class SelectorActionTransformer : public GraphTransformer {
 ...
 private:
  ...
  Ort::Status ApplySelectorsAndActions(Graph& graph, bool& modified, int graph_level, const Ort::Logger& logger,
  ...
  Ort::Status ApplySavedRuntimeOptimizations(Graph& graph, bool& modified, int graph_level,
