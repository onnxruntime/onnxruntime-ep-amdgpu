...
Ort::Status TransformLayoutForEP(Graph& graph, bool& modified, const IExecutionProvider& execution_provider,
  ...
  if (result.error_msg) {
    return ORT_MAKE_STATUS(ORT_FAIL, "Layout/Transpose optimization for ", execution_provider.Type(),
