 ...
 *               |              |
 */
static Ort::Status InsertCastNodes(Graph& graph,
...
static Ort::Status RemoveCastNodesChain(Graph& graph, gsl::span<Node* const> casts, NodeIndices& removed_nodes) {
...
static void InsertFP16Cast(Graph& graph, NodeArg* input_arg, Node* node,
                           NodeIndices& inserted_nodes, const Ort::Logger& logger) {
 ...
 */
Ort::Status PropagateCastOps::ApplyImpl(Graph& graph, bool& modified, int graph_level, const Ort::Logger& logger) const {
