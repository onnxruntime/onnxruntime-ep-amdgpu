...
class NodeArg {
  ...
  */
  ...
  Ort::Status OverrideTypesHelper(const ONNX_NAMESPACE::TypeProto& input_type,
  ...
  @param override_types If true, resolve the two inputs or two outputs type when different
  @returns Success unless there is existing type or shape info that can't be successfully updated. */
  Ort::Status UpdateTypeAndShape(const ONNX_NAMESPACE::TypeProto& input_type, bool strict, bool override_types, const Ort::Logger& logger);
  ...
  @param override_types If true, resolve the two inputs or two outputs type when different
  @returns Success unless there is existing type or shape info that can't be successfully updated. */
  Ort::Status UpdateTypeAndShape(const NodeArg& node_arg, bool strict, bool override_types, const Ort::Logger& logger);
