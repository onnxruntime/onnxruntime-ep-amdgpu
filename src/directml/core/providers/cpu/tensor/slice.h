...
class SliceBase {
 ...
 public:
  ...
  static Ort::Status PrepareForCompute(gsl::span<const int64_t> raw_starts,
  ...
  static Ort::Status FillVectorsFromInput(const Tensor& start_tensor,
  ...
  static Ort::Status FlattenOutputDims(gsl::span<const int64_t> input_dimensions, gsl::span<const int64_t> output_dims,
 ...
 protected:
  ...
  Ort::Status Compute(OpKernelContext* context) const;
...
struct Slice1 final : public OpKernel, public SliceBase {
  ...
  Ort::Status Compute(OpKernelContext* context) const override { return SliceBase::Compute(context); }
};
