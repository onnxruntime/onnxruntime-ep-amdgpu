...
class PadBase {
 public:
  ...
  static Ort::Status HandleDimValueZero(const Mode& mode, const TensorShape& input_shape, const TensorShape& output_shape);
  ...
  static Ort::Status ValidateTotalElementsCoverage(size_t total_output_elems,
                                              size_t prepad_elems,
                                              size_t copy_elems,
