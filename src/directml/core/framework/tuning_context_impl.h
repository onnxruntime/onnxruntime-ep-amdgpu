...
Ort::Status ITuningContext::LoadTuningResults(const TuningResults& tr) {
...
static Ort::Status CheckMandatoryKeys(
...
static Ort::Status CheckKeysMatching(
    const TuningResultsValidator::GetValidateFuncs& gv_funcs,
    const std::unordered_map<std::string, std::string>& to_check) {
...
Ort::Status TuningResultsValidator::ValidateOrtVersion(const std::string& value) const {
...
Ort::Status TuningResultsValidator::ValidateOrtGitCommit(const std::string& value) const {
  // TODO:
...
Ort::Status TuningResultsValidator::ValidateOrtBuildConfig(const std::string& value) const {
...
Ort::Status TuningResultsValidator::ValidateAll(const std::unordered_map<std::string, std::string>& to_validate) const {
