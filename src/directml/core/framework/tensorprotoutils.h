 ...
 * @returns                 STATUS_OK if the function is executed successfully
 */
...
Ort::Status GetTensorProtoWithDataIfInMemory(const ONNX_NAMESPACE::TensorProto& tensor_proto,
 ...
 */
Ort::Status TensorProtoToOrtValue(const Env& env, const std::filesystem::path& tensor_proto_path,
...
/// <returns>Status</returns>
Ort::Status GetExtDataFromTensorProto(const Env& env, const std::filesystem::path& model_path,
                                         const ONNX_NAMESPACE::TensorProto& tensor_proto,
...
// model_path is used for constructing full path for external_data
Ort::Status DenseTensorToSparseTensorProto(const ONNX_NAMESPACE::TensorProto& dense,
                                              const std::filesystem::path& model_path,
 ...
 * @returns                STATUS_OK if data is unpacked successfully
 */
Ort::Status UnpackInitializerData(const ONNX_NAMESPACE::TensorProto& initializer,
                                     const std::filesystem::path& model_path,
...
template <> struct fmt::formatter<ONNX_NAMESPACE::TensorProto_DataType> : formatter<std::string_view> {
    format_context::iterator format(ONNX_NAMESPACE::TensorProto_DataType format, format_context& ctx) const {
        ...
        case ONNX_NAMESPACE::TensorProto_DataType::TensorProto_DataType_DOUBLE:
            name = "DOUBLE";
            break;
        case ONNX_NAMESPACE::TensorProto_DataType::TensorProto_DataType_COMPLEX64:
            name = "COMPLEX64";
            break;
        case ONNX_NAMESPACE::TensorProto_DataType::TensorProto_DataType_COMPLEX128:
            name = "COMPLEX128";
            break;
        ...
        case ONNX_NAMESPACE::TensorProto_DataType::TensorProto_DataType_FLOAT4E2M1:
            name = "FLOAT4E2M1";
            break;
        case ONNX_NAMESPACE::TensorProto_DataType::TensorProto_DataType_FLOAT8E8M0:
            name = "FLOAT8E8M0";
            break;
        case ONNX_NAMESPACE::TensorProto_DataType::TensorProto_DataType_UINT2:
            name = "UINT2";
            break;
        case ONNX_NAMESPACE::TensorProto_DataType::TensorProto_DataType_INT2:
            name = "INT2";
            break;
...
template <> struct fmt::formatter<ONNX_NAMESPACE::AttributeProto_AttributeType> : formatter<std::string_view> {
    format_context::iterator format(ONNX_NAMESPACE::AttributeProto_AttributeType attribute, format_context& ctx) const {
        std::string_view name{"UNDEFINED"};
        switch (attribute) {
        ...
        case ONNX_NAMESPACE::AttributeProto_AttributeType::AttributeProto_AttributeType_GRAPH:
            name = "GRAPH";
            break;
        case ONNX_NAMESPACE::AttributeProto_AttributeType::AttributeProto_AttributeType_SPARSE_TENSOR:
            name = "SPARSE_TENSOR";
            break;
        case ONNX_NAMESPACE::AttributeProto_AttributeType::AttributeProto_AttributeType_TYPE_PROTO:
            name = "TYPE_PROTO";
            break;
        ...
        case ONNX_NAMESPACE::AttributeProto_AttributeType::AttributeProto_AttributeType_STRINGS:
            name = "STRINGS";
            break;
        case ONNX_NAMESPACE::AttributeProto_AttributeType::AttributeProto_AttributeType_TENSORS:
            name = "TENSORS";
            break;
        case ONNX_NAMESPACE::AttributeProto_AttributeType::AttributeProto_AttributeType_GRAPHS:
            name = "GRAPHS";
            break;
        case ONNX_NAMESPACE::AttributeProto_AttributeType::AttributeProto_AttributeType_SPARSE_TENSORS:
            name = "SPARSE_TENSORS";
            break;
        case ONNX_NAMESPACE::AttributeProto_AttributeType::AttributeProto_AttributeType_TYPE_PROTOS:
            name = "TYPE_PROTOS";
            break;
