...
Ort::Status EpContextModelToProto(const onnxruntime::Model& ep_context_model,
  ...
  return ORT_MAKE_STATUS(FAIL, "Unexpected location for initializers while generating ",
                         validated_model_path);
}
