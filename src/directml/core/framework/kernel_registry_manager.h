...
class KernelRegistryManager {
 public:
  ...
  Ort::Status RegisterKernels(const ExecutionProviders& execution_providers);
  ...
  Ort::Status SearchKernelRegistry(const Node& node, const Ort::Logger& logger,
  ...
  Ort::Status CreateKernel(const Node& node,
