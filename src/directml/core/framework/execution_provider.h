...
using ComputeFunc = std::function<Ort::Status(FunctionState, const OrtApi*, OrtKernelContext*)>;
...
class IExecutionProvider {
 protected:
  ...
  IExecutionProvider(const std::string& type, OrtDevice device, const Ort::Logger& logger)
  ...
  */
  virtual Ort::Status Sync() const { return STATUS_OK; }
  ...
  */
  virtual Ort::Status OnRunStart(const onnxruntime::RunOptions& /*run_options*/) { return STATUS_OK; }
  ...
  */
  virtual Ort::Status OnRunEnd(bool /*sync_stream*/, const onnxruntime::RunOptions& /*run_options*/) {
    return STATUS_OK;
  }
  ...
  */
  virtual Ort::Status SetEpDynamicOptions(gsl::span<const char* const> /*keys*/,
   ...
   */
  virtual Ort::Status ReplayGraph(int /*graph_annotation_id*/) {
    return STATUS_OK;
  }
  ...
  */
  virtual Ort::Status OnSessionInitializationEnd() { return STATUS_OK; }
  ...
  */
  virtual Ort::Status Compile(const std::vector<FusedNodeAndGraph>& fused_nodes_and_graphs,
   ...
   */
  virtual Ort::Status ValidateCompiledModelCompatibilityInfo(const std::string& /*compatibility_info*/,
  ...
  void SetLogger(const Ort::Logger* logger) {
    logger_ = logger;
  }
 ...
 private:
  ...
  const Ort::Logger* logger_ = nullptr;
};
}  // namespace onnxruntime
