...
Ort::Status BFCArena::Extend(size_t rounded_bytes) {
  ...
  if (rounded_bytes > available_bytes) {
    return ORT_MAKE_STATUS(ORT_FAIL, "Available memory of ", available_bytes,
...
void* BFCArena::AllocateRawInternal(size_t num_bytes,
  ...
  if (status.IsOK()) {
    ...
    if (chunk != nullptr) {
      ...
      status = ORT_MAKE_STATUS(ORT_FAIL,
