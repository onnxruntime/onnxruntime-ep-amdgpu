...
Ort::Status CustomRegistry::RegisterCustomKernel(KernelDefBuilder& kernel_def_builder, const KernelCreateFn& kernel_creator) {
  return kernel_registry_->Register(kernel_def_builder, kernel_creator);
}

Ort::Status CustomRegistry::RegisterCustomKernel(KernelCreateInfo& create_info) {
...
Ort::Status CustomRegistry::RegisterOpSet(
