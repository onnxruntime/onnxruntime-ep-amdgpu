...
class ITensorAllocator {
 public:
   ...
   * allocation.
   */
  virtual Ort::Status FinalizePlan(InlinedHashMap<OrtDevice, size_t>& planned_memory_sizes_in_byte) = 0;
   ...
   * @return
   */
  virtual Ort::Status GetPreallocatedBuffer(int ort_value_index, const std::string& name,
   ...
   */
  virtual Ort::Status Trace(int ort_value_index, const ONNX_NAMESPACE::TensorProto* value) = 0;
