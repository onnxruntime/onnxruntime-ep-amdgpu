...
using SaveTensorFunction = std::function<Ort::Status(const std::string& name, int idx, const OrtValue& value,
...
Ort::Status SaveInputOutputNamesToNodeMapping(const GraphViewer& graph,
