...
class OrtValuePatternPlanner {
 public:
  ...
  Ort::Status TraceAllocation(int ort_value_idx, const AllocPlanPerValue::ProgramCounter& counter, size_t size);
#endif
  Ort::Status TraceAllocation(int ort_value_idx, size_t size);
  Ort::Status TraceFree(int ort_value_index);
