...
namespace Plugin_GridSample_uint16_float
{
    #include "DmlExecutionProvider/Operators/GeneratedShaders/grid_sample_uint16_float.h"
}

namespace Plugin_GridSample_uint_float
{
    #include "DmlExecutionProvider/Operators/GeneratedShaders/grid_sample_uint_float.h"
}

namespace Plugin_GridSample_uint64_float
{
    #include "DmlExecutionProvider/Operators/GeneratedShaders/grid_sample_uint64_float.h"
}

namespace Plugin_GridSample_int16_float
{
    #include "DmlExecutionProvider/Operators/GeneratedShaders/grid_sample_int16_float.h"
}

namespace Plugin_GridSample_int_float
{
    #include "DmlExecutionProvider/Operators/GeneratedShaders/grid_sample_int_float.h"
}

namespace Plugin_GridSample_int64_float
{
    #include "DmlExecutionProvider/Operators/GeneratedShaders/grid_sample_int64_float.h"
}

namespace Plugin_GridSample_fp16_float
{
    #include "DmlExecutionProvider/Operators/GeneratedShaders/grid_sample_fp16_float.h"
}

namespace Plugin_GridSample_float_float
{
    #include "DmlExecutionProvider/Operators/GeneratedShaders/grid_sample_float_float.h"
}

namespace Plugin_GridSample_uint16_fp16
{
    #include "DmlExecutionProvider/Operators/GeneratedShaders/grid_sample_uint16_fp16.h"
}

namespace Plugin_GridSample_uint_fp16
{
    #include "DmlExecutionProvider/Operators/GeneratedShaders/grid_sample_uint_fp16.h"
}

namespace Plugin_GridSample_uint64_fp16
{
    #include "DmlExecutionProvider/Operators/GeneratedShaders/grid_sample_uint64_fp16.h"
}

namespace Plugin_GridSample_int16_fp16
{
    #include "DmlExecutionProvider/Operators/GeneratedShaders/grid_sample_int16_fp16.h"
}

namespace Plugin_GridSample_int_fp16
{
    #include "DmlExecutionProvider/Operators/GeneratedShaders/grid_sample_int_fp16.h"
}

namespace Plugin_GridSample_int64_fp16
{
    #include "DmlExecutionProvider/Operators/GeneratedShaders/grid_sample_int64_fp16.h"
}

namespace Plugin_GridSample_fp16_fp16
{
    #include "DmlExecutionProvider/Operators/GeneratedShaders/grid_sample_fp16_fp16.h"
}

namespace Plugin_GridSample_float_fp16
{
    #include "DmlExecutionProvider/Operators/GeneratedShaders/grid_sample_float_fp16.h"
}
...
namespace PluginGridSampleHelpers
{
    // Divides and rounds
...
public:
    ...
    PluginDmlGridSampleOperator(IMLOperatorKernelCreationContext* context)
    {
        ...
        switch (gridDataType)
        {
            case MLOperatorTensorDataType::Float:
            {
                ...
                case MLOperatorTensorDataType::UInt16:
                    computePsoDesc.CS = CD3DX12_SHADER_BYTECODE(Plugin_GridSample_uint16_float::g_GridSample,
                                                                sizeof(Plugin_GridSample_uint16_float::g_GridSample));
                break;

                case MLOperatorTensorDataType::UInt32:
                computePsoDesc.CS = CD3DX12_SHADER_BYTECODE(Plugin_GridSample_uint_float::g_GridSample, sizeof(Plugin_GridSample_uint_float::g_GridSample));
                break;

                case MLOperatorTensorDataType::UInt64:
                computePsoDesc.CS = CD3DX12_SHADER_BYTECODE(Plugin_GridSample_uint64_float::g_GridSample, sizeof(Plugin_GridSample_uint64_float::g_GridSample));
                break;

                case MLOperatorTensorDataType::Int16:
                computePsoDesc.CS = CD3DX12_SHADER_BYTECODE(Plugin_GridSample_int16_float::g_GridSample, sizeof(Plugin_GridSample_int16_float::g_GridSample));
                break;

                case MLOperatorTensorDataType::Int32:
                computePsoDesc.CS = CD3DX12_SHADER_BYTECODE(Plugin_GridSample_int_float::g_GridSample, sizeof(Plugin_GridSample_int_float::g_GridSample));
                break;

                case MLOperatorTensorDataType::Int64:
                computePsoDesc.CS = CD3DX12_SHADER_BYTECODE(Plugin_GridSample_int64_float::g_GridSample, sizeof(Plugin_GridSample_int64_float::g_GridSample));
                break;

                case MLOperatorTensorDataType::Float16:
                computePsoDesc.CS = CD3DX12_SHADER_BYTECODE(Plugin_GridSample_fp16_float::g_GridSample, sizeof(Plugin_GridSample_fp16_float::g_GridSample));
                break;

                case MLOperatorTensorDataType::Float:
                computePsoDesc.CS = CD3DX12_SHADER_BYTECODE(Plugin_GridSample_float_float::g_GridSample, sizeof(Plugin_GridSample_float_float::g_GridSample));
                break;
            ...
            case MLOperatorTensorDataType::Float16:
            {
                ...
                {
                case MLOperatorTensorDataType::UInt16:
                computePsoDesc.CS = CD3DX12_SHADER_BYTECODE(Plugin_GridSample_uint16_fp16::g_GridSample, sizeof(Plugin_GridSample_uint16_fp16::g_GridSample));
                break;

                case MLOperatorTensorDataType::UInt32:
                computePsoDesc.CS = CD3DX12_SHADER_BYTECODE(Plugin_GridSample_uint_fp16::g_GridSample, sizeof(Plugin_GridSample_uint_fp16::g_GridSample));
                break;

                case MLOperatorTensorDataType::UInt64:
                computePsoDesc.CS = CD3DX12_SHADER_BYTECODE(Plugin_GridSample_uint64_fp16::g_GridSample, sizeof(Plugin_GridSample_uint64_fp16::g_GridSample));
                break;

                case MLOperatorTensorDataType::Int16:
                computePsoDesc.CS = CD3DX12_SHADER_BYTECODE(Plugin_GridSample_int16_fp16::g_GridSample, sizeof(Plugin_GridSample_int16_fp16::g_GridSample));
                break;

                case MLOperatorTensorDataType::Int32:
                computePsoDesc.CS = CD3DX12_SHADER_BYTECODE(Plugin_GridSample_int_fp16::g_GridSample, sizeof(Plugin_GridSample_int_fp16::g_GridSample));
                break;

                case MLOperatorTensorDataType::Int64:
                computePsoDesc.CS = CD3DX12_SHADER_BYTECODE(Plugin_GridSample_int64_fp16::g_GridSample, sizeof(Plugin_GridSample_int64_fp16::g_GridSample));
                break;

                case MLOperatorTensorDataType::Float16:
                computePsoDesc.CS = CD3DX12_SHADER_BYTECODE(Plugin_GridSample_fp16_fp16::g_GridSample, sizeof(Plugin_GridSample_fp16_fp16::g_GridSample));
                break;

                case MLOperatorTensorDataType::Float:
                computePsoDesc.CS = CD3DX12_SHADER_BYTECODE(Plugin_GridSample_float_fp16::g_GridSample, sizeof(Plugin_GridSample_float_fp16::g_GridSample));
                break;
        ...
        ID3D12GraphicsCommandList* commandList)
    {
        ...
        while (pendingElementCount > 0)
        {
            ...
            PluginGridSampleHelpers::GetNextDispatchSize(
                pendingElementCount,
                1,
                64,
                dispatchSizeX,
...
struct GridSampleShapeInferrer : public WRL::Base<IMLOperatorShapeInferrer>
{
    STDMETHOD(InferOutputShapes)(IMLOperatorShapeInferenceContext* context) noexcept
    {
        try
        {
            ...
            ORT_THROW_IF_FAILED(context->SetOutputTensorShape(0, gsl::narrow<uint32_t>(outputDims.size()), outputDims.data()));
        }
        catch (...)
        {
            return E_FAIL;
...
public:
        ...
        IMLOperatorKernel** kernel)
    {
        try
        {
            auto dftOperator = wil::MakeOrThrow<PluginDmlGridSampleOperator>(context);
    ...
    static void RegisterGridSampleKernel(IMLOperatorRegistry* registry)
    {
        ...
        auto factory = wil::MakeOrThrow<PluginDmlGridSampleOperatorFactory>();
