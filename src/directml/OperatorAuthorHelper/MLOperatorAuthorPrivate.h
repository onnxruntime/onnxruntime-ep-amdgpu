...
//interface DECLSPEC_UUID("61DD78D4-5C65-4918-800E-401BF8AE4208") DECLSPEC_NOVTABLE
//IMLOperatorRegistryPlugin : public IUnknown
//{
//    STDMETHOD(RegisterOperatorKernel)(
//        const MLOperatorKernelDescription* operatorKernel,
//        IMLOperatorKernelFactory* operatorKernelFactory,
...
//        ) const noexcept PURE;
//
//    STDMETHOD(RegisterOperatorKernelPlugin)(
//        const MLOperatorKernelDescription* operatorKernel,
//        IMLOperatorKernelFactory* operatorKernelFactory,
//        _In_opt_ IMLOperatorShapeInferrer* shapeInferrer,
//        _In_opt_ IMLOperatorSupportQueryPrivate* supportQuery,
...
//        _In_reads_(aliasCount) const std::pair<uint32_t, uint32_t>* aliases = nullptr,
//        uint32_t aliasCount = 0,
//        const IUnknown* executionProvider = nullptr
//        ) const noexcept PURE;
//};
