...
private:
    ...
    struct
    {
        ComPtr<PluginGpuDFTOperator> op;
...
public:
    ...
    STDMETHOD(Compute)(IMLOperatorKernelContext* context)
    {
        try
        {
            ...
            ComPtr<ID3D12Resource> outputResource = PluginDmlSTFTHelpers::GetOutputResourceFromKernelContext(context, 0);
    ...
    void DispatchFramingOperator(ID3D12GraphicsCommandList* commandList, IMLOperatorKernelContext* context, ID3D12Resource* outputResource)
    {
        ...
        ComPtr<ID3D12Resource> signalResource = PluginDmlSTFTHelpers::GetInputResourceFromKernelContext(context, PluginDmlSTFTKernelInputIndex::Signal);
