...
class DmlOperatorQLinearConv : public DmlOperator, public OperatorHelper::ConvolutionHelperBase
{
private:
    enum InputTensors
    {
...
public:
        ...
        ConvolutionHelperBase(kernelInfo, kernelInfo.GetTensorShapeDescription(), false, false, false, 0, 3)
    {
        ...
        m_inputTensorDescs[IN_F] = CreateTensorDescFromInput(kernelInfo, 3/*Onnx Index*/, OperatorHelper::TensorAxis::DoNotCoerce, OperatorHelper::TensorAxis::NoPlacementAdjustment, OperatorHelper::NonspatialDimensionCount, std::nullopt);
