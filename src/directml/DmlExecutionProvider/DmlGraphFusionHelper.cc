...
namespace DmlGraphFusionHelper
{
    ...
    void ProcessInputData(
        const PluginDmlExecutionProviderImpl* providerImpl,
        ...
        const std::unordered_map<std::string_view, uint32_t>* serializedGraphLargeConstantNameToSubgraphInputIndex)
    {
        ...
        auto fused_kernel_func = [compiledExecutionPlanOperator,
                    ...
                    (onnxruntime::FuncManager& func_mgr, const onnxruntime::OpKernelInfo& info, std::unique_ptr<onnxruntime::OpKernel>& out) mutable ->Ort::Status
        {
    ...
    //        ownedInitializers = std::move(ownedInitializers)] (onnxruntime::FuncManager& func_mgr, const onnxruntime::OpKernelInfo& info, std::unique_ptr<onnxruntime::OpKernel>& out) mutable ->Ort::Status
    //    {
