...
namespace dml_ep {
    ...
    public: // implements IExecutionProvider
        ...
        Ort::Status CopyTensor(const onnxruntime::Tensor& src, onnxruntime::Tensor& dst) const;
        Ort::Status CopyTensors(const std::vector<onnxruntime::IDataTransfer::SrcDstPair>& src_dst_pairs) const;
       ...
       uint64_t TryGetPooledAllocationId(
        ...
        Ort::Status OnRunStart(const onnxruntime::RunOptions& run_options);
        Ort::Status OnRunEnd();
    ...
    public:
        ...
        Ort::Status CopyTensor(const onnxruntime::Tensor& src, onnxruntime::Tensor& dst) const final
        {
    ...
    public:
        ...
        Ort::Status OnSessionInitializationEnd() override
        {
            return m_impl->OnSessionInitializationEnd();
        }

        Ort::Status Sync() const final override
        {
        ...
        Ort::Status OnRunStart(const onnxruntime::RunOptions& run_options) final
        {
            return m_impl->OnRunStart(run_options);
        }

        Ort::Status OnRunEnd(bool /*sync_stream*/, const onnxruntime::RunOptions& /*run_options*/) final
        {
        ...
        Ort::Status ReplayGraph(int graph_annotation_id) override
        {
