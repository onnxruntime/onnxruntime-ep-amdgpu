...
PluginDmlPooledUploadHeap::PluginDmlPooledUploadHeap(ID3D12Device* device, PluginDmlExecutionContext* executionContext)
    ...
    std::pair<PluginDmlPooledUploadHeap::Chunk*, size_t> PluginDmlPooledUploadHeap::Reserve(size_t sizeInBytes)
    {
    ...
    void PluginDmlPooledUploadHeap::ReclaimAllocations()
    {
        for (Chunk& chunk : m_chunks)
        {
    ...
    GpuEvent PluginDmlPooledUploadHeap::BeginUploadToGpu(
        ID3D12Resource* dst,
        uint64_t dstOffset,
