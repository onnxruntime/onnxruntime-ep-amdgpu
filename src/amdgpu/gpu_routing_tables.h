...
//     (Strix, Halo, Krackan, Gorgon Point), Auto routes to HIP whenever model_arch is present (any
//     non-empty value OGA sends, including families this binary has never seen). kLlmModelArch is
//     the documented P0 set only.
...
//     arch defaults (including the gfx115x HIP presence rule). This is the hook for specific
//     GPU + model combinations (e.g. a named arch that must stay on MIGraphX on gfx115). Empty
