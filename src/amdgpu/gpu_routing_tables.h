...
//     arch defaults (including the gfx115x / gfx117x HIP presence rule). This is the hook for
//     specific GPU + model combinations (e.g. a named arch that must stay on MIGraphX). Empty
