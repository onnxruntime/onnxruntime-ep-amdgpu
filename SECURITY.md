...
This policy covers code and configuration in this repository. For issues in third-party dependencies, 
report upstream. For AMD product issues unrelated to this repo, use the [AMD Product Security portal](https://www.amd.com/en/resources/product-security.html).
